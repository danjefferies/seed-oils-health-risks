<script>
  ...
  const chartSteps = [
  "<p><span style='background-color: #0B5FA5; color: whitesmoke'>Beef</span> was the most popular option for protein in the U.S. historically, but the decline in its consumption can largely be attributed to the concern that saturated fat led to heart disease.</p>",
  "<p>Americans began to replace beef with <span style='background-color: #B8C46B;'>chicken</span>, which is the most popular form of animal protein in the U.S. today.</p>",
  "<p><span style='background-color: #D773D3; color: whitesmoke;'>Milk consumption</span> has declined since the 1970s, but yogurt and other dairy products have gained popularity, keeping dairy intake steady.</p>",
  "<p>What about <span style='background-color: #FDC64B;'>eggs</span>?</p>",
  "<p>The majority of calories in the American diet actually come from carbohydrates and <span style='background-color: #c90000; color: whitesmoke'>added oils</span>. Note that in 2000, the number of firms reporting vegetable oil production increased. Regardless, there are significantly more calories from added oils than animal fats.</p>",
  "<p>Over the last five decades, Americans have eaten similar amounts of saturated fat, yet obesity, cardiovascular disease 🫀and Alzheimer’s 🧠 are still rampant.</p>",
  "<p>If the Diet-Heart Hypothesis were right, our rates of these diseases would have decreased 📉 with the increase of unsaturated fat 📈 over the past 60 years.</p>"
  ];
</script>
...
<section class="narrative">
  ...
  <p>Not all plant-based oils are seed oils. Olive, avocado and coconut oils are pressed from the fruit, rather than the seeds, leading to lower polyunsaturated fat and higher monounsaturated or saturated fat content.</p>

  <p>One of the reasons corn and soybean oil are omnipresent is that they are products of industrial agriculture, which thrives on subsidizing monocrops for mass production. In addition, many seed oils come from genetically modified seeds – canola is a form of rapeseed <a href="https://scholarworks.iupui.edu/bitstream/handle/1805/808/GE%20canola.pdf?sequence=1" target="_blank">genetically modified</a> to resist herbicide spray or produce more oil. Surplus of cheap corn and soy turns into high-fructose corn syrup, sweeteners, preservatives and citric acid among other things, including seed oils.</p>
...
<section class="narrative" aria-label="section">
  ...
  <p>Similar to the labeling on organic and non-GMO items, the “heart healthy” AHA stamp of approval is found on many ultra-processed foods, encouraging their consumption as part of a diet that supposedly protects cardiovascular health.</p>

  <p>There is some conflicting evidence in the sphere of seed oil research. The Minnesota Coronary Survey, a randomized controlled trial that ran from 1968 to 1973, examined whether “traditional American foods” or those substituted with vegetable oils were associated with higher incidence of cardiovascular events. Some of the data – no significant results – was <a href="https://www.ahajournals.org/doi/10.1161/01.ATV.9.1.129" target="_blank">published in an official AHA journal in 1989</a>. Upon re-evaluation of the unpublished data in 2016, researchers concluded that while replacing saturated fat with polyunsaturated fat lowered blood cholesterol levels, it did not translate to lower risk of death from coronary heart disease. Rather, in adults over 65, a decrease in blood cholesterol led to a <a href="https://www.bmj.com/content/353/bmj.i1246" target="_blank">35% higher risk of death</a>.</p>

  <p>A global study endorsed by the AHA involving 70,000 participants – one of, if not the largest pooled analyses looking at linoleic acid levels in blood and adipose tissue – found <a href="https://www.ahajournals.org/doi/full/10.1161/CIRCULATIONAHA.118.038908#d1e3626" target="_blank">reduced risk of cardiovascular events</a> in those with higher levels of Omega-6 polyunsaturated fats. A 2010 <a href="https://journals.plos.org/plosmedicine/article?id=10.1371/journal.pmed.1000252" target="_blank">Harvard School of Public Health study</a> found a 19% reduced risk of cardiac events and suggests “that rather than trying to lower [polyunsaturated fat] consumption, a shift toward greater population PUFA consumption” would reduce heart disease significantly.  </p>
</section>
...
<section class="narrative">
  ...
  <p>Although the U.S. is not the only country that consumes seed oils, Americans get significantly more of their daily calories from them. According to updated data from the United Nations Food and Agriculture Statistics – the same datasets Ancel Keys would have used in his model – people in the U.S. consume upward of 500 calories per day from soybean oil alone. </p>
</section>
</main>
